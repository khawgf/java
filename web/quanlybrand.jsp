    ...
    <body>
            ...
            <a href="adminhome.jsp">Quay về trang chủ</a>
                    ...
                    <div class="apps__content-header">
                       <div class="apps__content-heading">
                        ...
                        <form action="quanlybrandController" method="get" style="display: flex;align-items: center;" id="searchForm">
                        ...
                        <div class="apps__content-add-product" onclick="showModalAdd();">
                            <button><i class="fas fa-cart-plus"></i> Thêm brand</button>
                        </div>
                    </div>
                    ...
                    <div class="apps__content-container">
                        ...
                        <div class="pagination">
                            <div class="pagination__list">
                                ...
                                <a href="quanlybrandController" class="pagination__list-link">
                                    <div class="pagination__list-item">Trang chủ</div>
                                </a>

                                <!-- Liên kết trang trước -->
                                <c:if test="${currentPage > 1}">
                                    <a href="quanlybrandController?page=${currentPage - 1}" id="prePage" class="pagination__list-link">
                                ...
                                <c:forEach begin="1" end="${totalPages}" varStatus="pageVar">
                                    <c:choose>
                                        ...
                                        <c:otherwise>
                                            <a href="quanlybrandController?page=${pageVar.index}&searchUser=${param.searchUser}" class="pagination__list-link">
                                ...
                                <c:if test="${currentPage < totalPages}">
                                    <a href="quanlybrandController?page=${currentPage + 1}" id="nextPage" class="pagination__list-link">
                        ...
                        <div class="modal__add-product" style="display: none;">
                            ...
                            <div class="modal__add-product-content">
                                ...
                                <div class="modal__add-product-header">
                                    <p class="modal__add-product-header-heading">Thêm mới brand</p>
                                </div>
                                <!--FORM_THEMMOI-->
                                ...
                                <div class="modal__add-product-origin">
                                    ...
                                    <input type="text" placeholder="Tên brand" value="" id="txtadminname">
                                </div>
        ...
        <script>
                                    function actionAddProduct() {
                                            ...
                                            xhr.open("POST", "quanlybrandController", true);
                                    ...
                                    function showModalAdd()
                                    {
                                        ...
                                        document.querySelector('.modal__add-product-header-heading').innerText = "Thêm brand mới";
                                    ...
                                    function showModalUpdate(id,name,phone)
                                    {
                                        ...
                                        document.querySelector('.modal__add-product-header-heading').innerText = "Cập nhật brand";
